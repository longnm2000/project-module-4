...
function BranchesManagerPage() {
    ...
    const fetchData = async () => {
        await axios
            .get(`http://localhost:3000/api/v1/manufacturers`)
    ...
    const handleDelete = (id: number) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios
                    .delete(`http://localhost:3000/api/v1/manufacturers/${id}`)
                    .then((response) => {
    ...
    const onSubmit = async (data: object) => {
        ...
        try {
            const response: AxiosResponse = await axios.post(
                "http://localhost:3000/api/v1/manufacturers",
                data
            );
...
export default BranchesManagerPage;
